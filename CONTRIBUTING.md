...
3. Tag: `git tag -a v1.0.0 -m "v1.0.0"`
...
- **Review your changes** — AI-generated code must be reviewed before submitting; you are responsible for every line in your PR regardless of who or what wrote it
- **Test your changes** — Run `cargo build` and manual testing before opening a PR
- **No AI slop** — PRs containing obvious low-effort AI output will be closed without review. Red flags include:
  - Unrequested refactors, defensive checks for impossible states, or abstractions a small change doesn't need
  - Boilerplate comments narrating the obvious, doc comments restating function names, or commit messages padded with filler
  - Hallucinated APIs, invented config options, dependencies added for trivial tasks, or code that doesn't compile against this codebase
  - Massive diffs with mostly whitespace/reformat churn mixed into functional changes
